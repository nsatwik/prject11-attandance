...
<center><h1>Faculty Registration Form</h1>
    <form method="post" action="addfacultyintodatabase.php">
      <label for="facultyid">Faculty ID:</label>
      <input type="text" id="facultyid" name="facultyid" minlength="3" required>
      <label for="facultyname">Faculty Name:</label>
      <input type="text" id="facultyname" name="facultyname"  required>
      <label for="gmail">Gmail:</label>
      <input type="email" id="gmail" name="gmail" required>
      <label for="subject">Subject:</label>
      <input type="text" id="subject" name="subject" minlength="3" required>
