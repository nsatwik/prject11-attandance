...
$query3 = "select * from studentdetails where studentid='$rollno'";
        ...
        <tbody>
            <?php
                ...
                $query1 = "create view temp AS
                select count(*) as total from $rollno;";
                $result1=mysqli_query($conn,$query1);

                $query2 = "SELECT studentdetails.studentname, (COUNT(*)*100)/total as Percentage from studentdetails, $rollno,temp where $rollno.status='present' and studentdetails.studentid='$rollno';";
